...
## Phase 3.1: Setup
- [ ] T001 Create project structure and package files
  - Files: 
...
- [ ] T002 Initialize `pyproject.toml` with Python 3.12, deps, and tool configs
...
- [ ] T003 [P] Add Docker Compose for PocketBase (and optional app)
...
- [ ] T004 [P] Example config file for mappings and destinations
...
- [ ] T005 [P] CI workflow to run tests and archive reports
...
- [ ] T006 PocketBase migrations (Go) for collections
...
- [ ] T007 [P] Contract test for GET /healthz
...
- [ ] T008 [P] Contract test for POST /webhook/{source}
...
- [ ] T009 [P] Integration test — primary user story
...
- [ ] T010 [P] Integration test — payload too large (413)
...
- [ ] T011 [P] Integration test — missing mapped fields resolve empty
...
- [ ] T012 [P] Integration test — destination timeout -> failed delivery
...
- [ ] T013 Create FastAPI app factory and health endpoint
  - Files:
...
- [ ] T014 Config loader for mappings/destinations with auto-reload
...
- [ ] T015 Dotted-path field extractor
...
- [ ] T016 PocketBase REST client wrapper
...
- [ ] T017 Outbound delivery service
...
- [ ] T018 Webhook endpoint implementation
  - Files:
...
- [ ] T019 Prometheus metrics exposure
...
- [ ] T020 Admin CLI command `purge-events` + runbook
  - Files:
...
- [ ] T021 Structlog configuration and request logging middleware
...
- [ ] T022 Dev server wiring and quickstart validation
...
- [ ] T023 Update OpenAPI contract as needed
...
## Phase 3.5: Polish
- [ ] T024 [P] Unit tests for mapping/config/metrics
...
- [ ] T026 [P] Update quickstart and examples
...
- [ ] T027 [P] Update AGENTS.md manual notes
